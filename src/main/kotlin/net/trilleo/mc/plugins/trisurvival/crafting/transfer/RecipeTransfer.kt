 ...
 * @param rules        the transfer steps to apply; defaults to custom-enchant and reforge transfer
 */
data class RecipeTransfer(
    val sourceItemId: String,
    val rules: List<TransferRule> = listOf(EnchantTransferRule, ReforgeTransferRule)
)
