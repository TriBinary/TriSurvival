...
import net.trilleo.mc.plugins.trisurvival.collections.*
...
object FarmingCollections : CollectionProvider() {
    ...
    override fun collections(): List<Collection> = listOf(
        ...
        farming(
            ...
            "Sugar Cane",
            Material.SUGAR_CANE,
            listOf(Vanilla(Material.SUGAR_CANE)),
            placedFilter = true
        ),
        ...
        farming(
            ...
            listOf(Vanilla(Material.RED_MUSHROOM)),
            placedFilter = true
        ),
        farming(
            "brown_mushroom",
            ...
            listOf(Vanilla(Material.BROWN_MUSHROOM)),
            placedFilter = true
        )
    )
}
