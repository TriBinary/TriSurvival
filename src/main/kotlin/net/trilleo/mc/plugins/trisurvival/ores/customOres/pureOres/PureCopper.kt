...
object PureCopper : CustomOre("pure_copper") {

    override val representingBlock: Material = Material.WAXED_COPPER_BLOCK
    override val blockStrength: Int = 250
    override val dropVanillaItem: Material = Material.COPPER_INGOT
    override val baseDropAmount: Int = 3
    override val skillXp: Double = 15.0
