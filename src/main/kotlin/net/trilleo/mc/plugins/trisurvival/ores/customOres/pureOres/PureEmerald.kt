...
object PureEmerald : CustomOre("pure_emerald") {

    override val representingBlock: Material = Material.EMERALD_BLOCK
    override val blockStrength: Int = 400
    override val dropVanillaItem: Material = Material.EMERALD
    override val baseDropAmount: Int = 3
    override val skillXp: Double = 30.0
    ...
    override fun generate(chunk: Chunk, world: World, random: Random) {
        val attempts = random.nextInt(0, 1)
        repeat(attempts) {
