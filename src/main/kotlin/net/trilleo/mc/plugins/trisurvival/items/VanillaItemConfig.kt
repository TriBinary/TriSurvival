...
object VanillaItemConfig {
    ...
    private fun registerArmor() {
        ...
        // Iron
        register(
            Material.IRON_HELMET, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.HELMET,
                mapOf(Stat.HEALTH to 15.0, Stat.DEFENSE to 20.0)
            )
        )
        register(
            Material.IRON_CHESTPLATE, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.CHESTPLATE,
                mapOf(Stat.HEALTH to 25.0, Stat.DEFENSE to 40.0)
            )
        )
        register(
            Material.IRON_LEGGINGS, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.LEGGINGS,
                mapOf(Stat.HEALTH to 20.0, Stat.DEFENSE to 30.0)
            )
        )
        register(
            Material.IRON_BOOTS, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.BOOTS,
        ...
        // Turtle
        register(
            Material.TURTLE_HELMET, VanillaItemProfile(
                ItemRarity.RARE, ItemType.HELMET,
        ...
        // Elytra
        register(
            Material.ELYTRA, VanillaItemProfile(
    ...
    private fun registerTools() {
        ...
        // Shovels
        register(
            Material.WOODEN_SHOVEL, VanillaItemProfile(
                ItemRarity.COMMON, ItemType.NONE,
                mapOf(Stat.DAMAGE to 8.0)
            )
        )
        register(
            Material.STONE_SHOVEL, VanillaItemProfile(
                ItemRarity.COMMON, ItemType.NONE,
                mapOf(Stat.DAMAGE to 12.0)
            )
        )
        register(
            Material.GOLDEN_SHOVEL, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.NONE,
                mapOf(Stat.DAMAGE to 8.0)
            )
        )
        register(
            Material.IRON_SHOVEL, VanillaItemProfile(
                ItemRarity.UNCOMMON, ItemType.NONE,
                mapOf(Stat.DAMAGE to 16.0)
            )
        )
        register(
            Material.DIAMOND_SHOVEL, VanillaItemProfile(
                ItemRarity.RARE, ItemType.NONE,
                mapOf(Stat.DAMAGE to 20.0)
            )
        )
        register(
            Material.NETHERITE_SHOVEL, VanillaItemProfile(
